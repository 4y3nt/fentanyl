...
pcall(function() game.CoreGui["f3ntanyl"]:Destroy() end)
...
Min.MouseButton1Click:Connect(function()
    game.StarterGui:SetCore("SendNotification", {
        Title = "f3ntanyl";
        Text = "f3ntanyl hide. Press P to back.";
        Duration = 2;
    })
    MainFrame.Visible = false
    synminbutt.Visible = false
...
title.Text = "f3ntanyl - overdoseonfentanyl"
title.TextColor3 = Color3.fromRGB(0, 2, 2)
title.TextSize = 16.000

list.Name = "list"
list.Parent = MainFrame
list.BackgroundColor3 = Color3.fromRGB(255, 255, 253)
...
execute.MouseButton1Click:Connect(function()
    ...
    if injected == false then
        title.Text = "f3ntanyl - (Not injected! Press attach)"
    end
end)
...
clear.Text = "Clear"
clear.TextColor3 = Color3.fromRGB(5, 5, 5)
...
scripthub.Name = "overdoseonfentanyl"
scripthub.Parent = MainFrame
scripthub.BackgroundColor3 = Color3.fromRGB(255, 254, 254)
...
scripthub.Text = "Overdoseonfent"
scripthub.TextColor3 = Color3.fromRGB(2, 2, 2)
scripthub.TextSize = 14.000
scripthub.MouseButton1Click:Connect(function()
    if scripthub_2.Visible == false then
...
Attach.BackgroundColor3 = Color3.fromRGB(255 , 255 , 250)
...
Attach.MouseButton1Click:Connect(function()
    if injected == true then
        title.Text = "f3ntanyl - (Already injected!)"
        wait(1)
        title.Text = "f3ntanyl - status:injected"
    end
    if injected == false then
        title.Text = "f3ntanyl - (Checking...)"
        wait(0.1)
        title.Text = "f3ntanyl - (Injecting...)"
        wait(1.5)
        title.Text = "f3ntanyl - (Checking Whitelist...)"
        wait(0.8)
        title.Text = "f3ntanyl - (Scanning...)"
        wait(0.3)
        title.Text = "f3ntanyl - (Ready!)"
        wait(0.5)
        title.Text = "f3ntanyl - status:injected"
        injected = true
    end
...
title_2.ZIndex = 14
title_2.Image = "https://tr.rbxcdn.com/30DAY-Avatar-F3B8A676EF75D5523F9E36725CBA8ADF-Png/352/352/Avatar/Webp/noFilter"
...
optionspage.BackgroundColor3 = Color3.fromRGB(250, 255, 245)
...
title_3.Text = "f3ntanyl - Script Hub"
...
title_5.Text = "f3ntanyl - Options Menu"
...
synapsex3.MouseButton1Click:Connect(function()
    game.StarterGui:SetCore("SendNotification", {
        Title = "Coming soon - overdose on fentanyl";
        Text = "f3ntanyl v3 coming soon.";
        Duration = 1;
    })
